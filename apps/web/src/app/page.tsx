          ...
          {activeTab === 'rooms' && (
            <div className="h-full animation-fade-in">
              <header className="mb-8 flex justify-between items-center">
                ...
                <button onClick={() => setIsRoomModalOpen(true)} className="flex items-center gap-2 bg-primary hover:bg-primary/80 text-primary-foreground px-6 py-2.5 rounded-lg font-medium shadow-[0_0_15px_rgba(59,130,246,0.4)]">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animation-fade-in">
          <div className="glass-panel w-full max-w-md p-6 rounded-2xl border border-white/10 shadow-2xl relative">
            ...
            <form onSubmit={handleAddRoom} className="space-y-4">
              ...
              <div className="pt-4 flex justify-end gap-3"><button type="button" onClick={() => setIsRoomModalOpen(false)} className="px-4 py-2 text-zinc-400 hover:text-white">Cancelar</button><button type="submit" className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 rounded-lg font-medium">Salvar Sala</button></div>
            </form>
          </div>
        </div>
      )}
